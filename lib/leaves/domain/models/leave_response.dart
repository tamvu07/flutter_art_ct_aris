...
class LeaveResponse {
  ...
  LeaveResponse.fromJson(dynamic json) {
    _code = json['code'];
    _msg = json['msg'];
...
class ResponseData {
  ...
  ResponseData.fromJson(dynamic json) {
    ...
    if (json['data'] != null) {
      _data = [];
      json['data'].forEach((v) {
        _data?.add(LeaveData.fromJson(v));
      });
    }
...
class LeaveData extends LeaveDetails {
  LeaveData({
    int? id,
    String? title,
    String? description,
